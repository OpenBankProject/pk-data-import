...
class PermissionJSON(object):
    ...
    def __init__(self, user=None, views=None, _configuration=None):  # noqa: E501
        """PermissionJSON - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def user(self):
        """Gets the user of this PermissionJSON.  # noqa: E501
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this PermissionJSON.
    ...
    @property
    def views(self):
        """Gets the views of this PermissionJSON.  # noqa: E501
    ...
    def views(self, views):
        """Sets the views of this PermissionJSON.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PermissionJSON, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PermissionJSON):
            return False
