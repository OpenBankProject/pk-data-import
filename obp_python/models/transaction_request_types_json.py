...
class TransactionRequestTypesJSON(object):
    ...
    def __init__(self, transaction_request_types=None, _configuration=None):  # noqa: E501
        """TransactionRequestTypesJSON - a model defined in Swagger"""  # noqa: E501
    ...
    def transaction_request_types(self):
        """Gets the transaction_request_types of this TransactionRequestTypesJSON.  # noqa: E501


        :return: The transaction_request_types of this TransactionRequestTypesJSON.  # noqa: E501
        :rtype: list[TransactionRequestTypeJSONV210]
        """
    ...
    def transaction_request_types(self, transaction_request_types):
        """Sets the transaction_request_types of this TransactionRequestTypesJSON.


        :param transaction_request_types: The transaction_request_types of this TransactionRequestTypesJSON.  # noqa: E501
        :type: list[TransactionRequestTypeJSONV210]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TransactionRequestTypesJSON, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TransactionRequestTypesJSON):
            return False
