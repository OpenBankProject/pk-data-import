...
class DocumentationApi(object):
    ...
    def get_api_glossary(self, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_api_glossary(body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_api_glossary_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.get_api_glossary_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def get_api_glossary_with_http_info(self, body, **kwargs):  # noqa: E501
        """Get Glossary of the API  # noqa: E501

        <p>Get API Glossary</p><p>Returns the glossary of the API</p><p>Authentication is Optional</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_api_glossary_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_api_glossary" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('body' not in params or
            ...
            raise ValueError("Missing the required parameter `body` when calling `get_api_glossary`")  # noqa: E501
