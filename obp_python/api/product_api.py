...
class ProductApi(object):
    ...
    def delete_product_attribute(self, body, product_attribute_id, product_code, bank_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_product_attribute(body, product_attribute_id, product_code, bank_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_product_attribute_with_http_info(body, product_attribute_id, product_code, bank_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_product_attribute_with_http_info(body, product_attribute_id, product_code, bank_id, **kwargs)  # noqa: E501
            return data

    def delete_product_attribute_with_http_info(self, body, product_attribute_id, product_code, bank_id, **kwargs):  # noqa: E501
        """Delete Product Attribute  # noqa: E501

        <p>Delete Product Attribute</p><p>Product Attributes are used to describe a financial Product with a list of typed key value pairs.</p><p>Each Product Attribute is linked to its Product by PRODUCT_CODE</p><p>Delete a Product Attribute by its id.</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_product_attribute_with_http_info(body, product_attribute_id, product_code, bank_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `delete_product_attribute`")  # noqa: E501
    ...
    def get_product_collection(self, body, collection_code, bank_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_product_collection(body, collection_code, bank_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_product_collection_with_http_info(body, collection_code, bank_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_product_collection_with_http_info(body, collection_code, bank_id, **kwargs)  # noqa: E501
            return data

    def get_product_collection_with_http_info(self, body, collection_code, bank_id, **kwargs):  # noqa: E501
        """Get Product Collection  # noqa: E501

        <p>Returns information about the financial Product Collection specified by BANK_ID and COLLECTION_CODE:</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_product_collection_with_http_info(body, collection_code, bank_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `get_product_collection`")  # noqa: E501
        # verify the required parameter 'collection_code' is set
        if self.api_client.client_side_validation and ('collection_code' not in params or
                                                       params['collection_code'] is None):  # noqa: E501
    ...
    def get_product_tree(self, body, product_code, bank_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_product_tree(body, product_code, bank_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_product_tree_with_http_info(body, product_code, bank_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_product_tree_with_http_info(body, product_code, bank_id, **kwargs)  # noqa: E501
            return data

    def get_product_tree_with_http_info(self, body, product_code, bank_id, **kwargs):  # noqa: E501
        """Get Product Tree  # noqa: E501

        <p>Returns information about a particular financial product specified by BANK_ID and PRODUCT_CODE<br />and it's parent product(s) recursively as specified by parent_product_code.</p><p>Each product includes the following information.</p><ul><li>Name</li><li>Code</li><li>Parent Product Code</li><li>Category</li><li>Family</li><li>Super Family</li><li>More info URL</li><li>Description</li><li>Terms and Conditions</li><li>License: The licence under which this product data is released. Licence can be an Open Data licence such as Open Data Commons Public Domain Dedication and License (PDDL) or Copyright etc.</li></ul><p>Authentication is Optional</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_product_tree_with_http_info(body, product_code, bank_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `get_product_tree`")  # noqa: E501
        # verify the required parameter 'product_code' is set
        if self.api_client.client_side_validation and ('product_code' not in params or
                                                       params['product_code'] is None):  # noqa: E501
