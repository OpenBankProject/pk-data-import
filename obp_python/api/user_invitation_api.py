...
class UserInvitationApi(object):
    ...
    def get_user_invitation(self, bank_id, **kwargs):  # noqa: E501
        """Get User Invitation  # noqa: E501

        <p>Get User Invitation</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_invitation(bank_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_user_invitation_with_http_info(bank_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_user_invitation_with_http_info(bank_id, **kwargs)  # noqa: E501
            return data

    def get_user_invitation_with_http_info(self, bank_id, **kwargs):  # noqa: E501
        """Get User Invitation  # noqa: E501

        <p>Get User Invitation</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_invitation_with_http_info(bank_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_user_invitation" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'bank_id' is set
        if self.api_client.client_side_validation and ('bank_id' not in params or
                                                       params['bank_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `bank_id` when calling `get_user_invitation`")  # noqa: E501
    ...
    def get_user_invitations(self, bank_id, **kwargs):  # noqa: E501
        """Get User Invitations  # noqa: E501

        <p>Get User Invitations</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_invitations(bank_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_user_invitations_with_http_info(bank_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_user_invitations_with_http_info(bank_id, **kwargs)  # noqa: E501
            return data

    def get_user_invitations_with_http_info(self, bank_id, **kwargs):  # noqa: E501
        """Get User Invitations  # noqa: E501

        <p>Get User Invitations</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_invitations_with_http_info(bank_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_user_invitations" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'bank_id' is set
        if self.api_client.client_side_validation and ('bank_id' not in params or
                                                       params['bank_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `bank_id` when calling `get_user_invitations`")  # noqa: E501
