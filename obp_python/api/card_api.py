...
class CardApi(object):
    ...
    def delete_card_for_bank(self, body, card_id, bank_id, **kwargs):  # noqa: E501
        """Delete Card  # noqa: E501

        <p>Delete a Card at bank specified by CARD_ID .</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_card_for_bank(body, card_id, bank_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_card_for_bank_with_http_info(body, card_id, bank_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_card_for_bank_with_http_info(body, card_id, bank_id, **kwargs)  # noqa: E501
            return data

    def delete_card_for_bank_with_http_info(self, body, card_id, bank_id, **kwargs):  # noqa: E501
        """Delete Card  # noqa: E501

        <p>Delete a Card at bank specified by CARD_ID .</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_card_for_bank_with_http_info(body, card_id, bank_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `delete_card_for_bank`")  # noqa: E501
        # verify the required parameter 'card_id' is set
        if self.api_client.client_side_validation and ('card_id' not in params or
                                                       params['card_id'] is None):  # noqa: E501
    ...
    def get_card_for_bank(self, body, card_id, bank_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_card_for_bank(body, card_id, bank_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_card_for_bank_with_http_info(body, card_id, bank_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_card_for_bank_with_http_info(body, card_id, bank_id, **kwargs)  # noqa: E501
            return data

    def get_card_for_bank_with_http_info(self, body, card_id, bank_id, **kwargs):  # noqa: E501
        """Get Card By Id  # noqa: E501

        <p>This will the datails of the card.<br />It shows the account infomation which linked the the card.<br />Also shows the card attributes of the card.</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_card_for_bank_with_http_info(body, card_id, bank_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `get_card_for_bank`")  # noqa: E501
        # verify the required parameter 'card_id' is set
        if self.api_client.client_side_validation and ('card_id' not in params or
                                                       params['card_id'] is None):  # noqa: E501
    ...
    def get_cards_for_bank(self, body, bank_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_cards_for_bank(body, bank_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_cards_for_bank_with_http_info(body, bank_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_cards_for_bank_with_http_info(body, bank_id, **kwargs)  # noqa: E501
            return data

    def get_cards_for_bank_with_http_info(self, body, bank_id, **kwargs):  # noqa: E501
        """Get Cards for the specified bank  # noqa: E501

        <p>Should be able to filter on the following fields</p><p>eg:/management/banks/BANK_ID/cards?customer_id=66214b8e-259e-44ad-8868-3eb47be70646&amp;account_id=8ca8a7e4-6d02-48e3-a029-0b2bf89de9f0</p><p>1 customer_id should be valid customer_id, otherwise, it will return an empty card list.</p><p>2 account_id should be valid account_id , otherwise, it will return an empty card list.</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_cards_for_bank_with_http_info(body, bank_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `get_cards_for_bank`")  # noqa: E501
        # verify the required parameter 'bank_id' is set
        if self.api_client.client_side_validation and ('bank_id' not in params or
                                                       params['bank_id'] is None):  # noqa: E501
    ...
    def get_status_of_credit_card_order(self, body, view_id, account_id, bank_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_status_of_credit_card_order(body, view_id, account_id, bank_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_status_of_credit_card_order_with_http_info(body, view_id, account_id, bank_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_status_of_credit_card_order_with_http_info(body, view_id, account_id, bank_id, **kwargs)  # noqa: E501
            return data

    def get_status_of_credit_card_order_with_http_info(self, body, view_id, account_id, bank_id, **kwargs):  # noqa: E501
        """Get status of Credit Card order   # noqa: E501

        <pre><code>  Get status of Credit Card orders</code></pre><p>Get all orders</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_status_of_credit_card_order_with_http_info(body, view_id, account_id, bank_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `get_status_of_credit_card_order`")  # noqa: E501
