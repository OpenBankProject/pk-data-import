...
class ApiCollectionApi(object):
    ...
    def get_api_collections(self, user_id, **kwargs):  # noqa: E501
        """Get Api Collections  # noqa: E501

        <p>Get Api Collections.</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_api_collections(user_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_api_collections_with_http_info(user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_api_collections_with_http_info(user_id, **kwargs)  # noqa: E501
            return data

    def get_api_collections_with_http_info(self, user_id, **kwargs):  # noqa: E501
        """Get Api Collections  # noqa: E501

        <p>Get Api Collections.</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_api_collections_with_http_info(user_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_api_collections" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('user_id' not in params or
            ...
            raise ValueError("Missing the required parameter `user_id` when calling `get_api_collections`")  # noqa: E501
